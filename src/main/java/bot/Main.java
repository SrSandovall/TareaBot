...
public class Main {
    private static void PruebaInsertaUsuario() {
        ...
        user.setCarne("0905-12-1231312");
        user.setNombre("breinmclaren");
        user.setCorreo("gokuZzz@gmail.com");
        user.setSeccion("A");
    ...
    private static void PruebaActualizacionUsuario() {
        ...
        try {
            usurioObtenido = servicioUsuaio.getUserById(1);
          ...
          usurioObtenido.setCarne("0905-12-12");
            usurioObtenido.setNombre("NarutoZzz");
            usurioObtenido.setCorreo("gokuZzz@gmail.com");
