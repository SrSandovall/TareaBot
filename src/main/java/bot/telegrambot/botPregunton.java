...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_4", new String[]{"4.1 Ya tenes ganas de irte para tu casa?", " 4.2 Cuantos anios tienes?", "Pregunta 4.3", "Pregunta 4.2", "Pregunta 4.3"});
//validar en la preguntar 2 si la edad es valida y si el tipo de dato es valido
    }
